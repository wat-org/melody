 ...
 * 
 */
public class GetProtectedAreaId implements XPathFunction {

	public static final String NAME = "getProtectedAreaId";
	...
	public Object evaluate(List list) throws XPathFunctionException {
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return ProtectedAreaHelper.findProtectedAreaId((Element) arg0);
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return ProtectedAreaHelper
						.findProtectedAreaId((List<Element>) arg0);
			}
