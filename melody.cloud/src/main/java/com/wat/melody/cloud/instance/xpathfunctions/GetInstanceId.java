 ...
 * 
 */
public class GetInstanceId implements XPathFunction {

	public static final String NAME = "getInstanceId";
	...
	public Object evaluate(List list) throws XPathFunctionException {
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return InstanceDatasHelper.findInstanceId((Element) arg0);
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return InstanceDatasHelper.findInstanceId((List<Element>) arg0);
			}
