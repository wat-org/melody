 ...
 * 
 */
public class GetInstanceSite implements XPathFunction {

	public static final String NAME = "getInstanceSite";
	...
	public Object evaluate(List list) throws XPathFunctionException {
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return InstanceDatasHelper.findInstanceSite((Element) arg0);
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return InstanceDatasHelper
						.findInstanceSite((List<Element>) arg0);
			}
