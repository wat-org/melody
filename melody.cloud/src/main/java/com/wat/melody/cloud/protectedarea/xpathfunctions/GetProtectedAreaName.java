 ...
 * 
 */
public class GetProtectedAreaName implements XPathFunction {

	public static final String NAME = "getProtectedAreaName";
	...
	public Object evaluate(List list) throws XPathFunctionException {
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return XPathFunctionHelper.toString(ProtectedAreaHelper
						.findProtectedAreaName((Element) arg0));
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return XPathFunctionHelper.toString(ProtectedAreaHelper
						.findProtectedAreaName((List<Element>) arg0));
			}
