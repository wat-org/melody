 ...
 * 
 */
public class GetNetworkActivationDeviceName implements XPathFunction {

	public static final String NAME = "getNetworkActivationDeviceName";
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return XPathFunctionHelper.toString(NetworkActivationHelper
						.findNetworkActivationDeviceName((Element) arg0));
			}
