 ...
 * 
 */
public class GetNetworkActivationProtocol implements XPathFunction {

	public static final String NAME = "getNetworkActivationProtocol";
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return XPathFunctionHelper.toString(NetworkActivationHelper
						.findNetworkActivationProtocol((Element) arg0));
			}
