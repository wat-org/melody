...
public class GetInstanceKeyPairPassphrase implements XPathFunction {

	public static final String NAME = "getInstanceKeyPairPassphrase";
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return XPathFunctionHelper.toString(InstanceDatasHelper
						.findInstanceKeyPairPassphrase((Element) arg0));
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return XPathFunctionHelper.toString(InstanceDatasHelper
						.findInstanceKeyPairPassphrase((List<Element>) arg0));
			}
