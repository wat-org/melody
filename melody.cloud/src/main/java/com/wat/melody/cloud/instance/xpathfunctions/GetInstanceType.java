 ...
 * 
 */
public class GetInstanceType implements XPathFunction {

	public static final String NAME = "getInstanceType";
		...
		try {
			if (XPathFunctionHelper.isElement(arg0)) {
				return XPathFunctionHelper.toString(InstanceDatasHelper
						.findInstanceType((Element) arg0));
			} else if (XPathFunctionHelper.isElementList(arg0)) {
				return XPathFunctionHelper.toString(InstanceDatasHelper
						.findInstanceType((List<Element>) arg0));
			}
