 ...
 * 
 */
public class WinRmNetworkActivationDatas extends NetworkActivationDatas {
	...
	public WinRmNetworkActivationDatas(boolean activationEnabled,
	...
	public NetworkActivationProtocol getNetworkActivationProtocol() {
		return NetworkActivationProtocol.WINRM;
	}
