...
/**
 * <p>
 * XPath custom function, which return the AWS EC2 Secret Key (as defined in the
 ...
 * 
 */
public class GetAwsEc2SecretKey implements XPathFunction {

	public static final String NAME = "getAwsEc2SecretKey";
