...
public class Messages extends NLS {
	...
	public static String DUNIDDocEx_TEXT_INSERTED;
	public static String DUNIDDocEx_DUNID_ADD;
	public static String DUNIDDocEx_TEXT_REMOVED;
	public static String DUNIDDocEx_TEXT_MODIFIED;
	public static String DUNIDDocEx_DUNID_DEL;
	public static String DUNIDDocEx_DUNID_MOD;
	public static String DUNIDDocMsg_ELEMENT_INSERTED;
	public static String DUNIDDocMsg_ELEMENT_REMOVED;
	public static String DUNIDDocMsg_LEAF_TEXT_INSERTED;
	public static String DUNIDDocMsg_LEAF_TEXT_REMOVED;
	public static String DUNIDDocMsg_LEAF_TEXT_MODIFIED;
