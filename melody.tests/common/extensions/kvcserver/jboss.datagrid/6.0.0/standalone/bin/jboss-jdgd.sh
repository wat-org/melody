...
JDG_JAVA_OPTS="${JDG_JAVA_OPTS} -Djava.ext.dirs=$(dirname $(dirname $(readlink -f $(which ${JAVA}))))/lib/ext:/usr/java/packages/lib/ext:${JBOSS_BASE_DIR}/lib/ext"
# jboss datagrid command line
